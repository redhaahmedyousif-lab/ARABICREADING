...
// PDF files are kept in page state only (not persisted) until file storage exists.
const INITIAL_FILES: LibraryFile[] = [
  {
    id: 1,
    title: "قائمة الكتب القصيرة - النسخة الأولى (30 كتاباً)",
    description: "مختارات من الأدب العالمي والعربي بأقل من 130 صفحة مناسبة لمرحلة MYP.",
    size: "2.4 MB",
  ...
  {
    id: 2,
    title: "قائمة الكتب القصيرة - النسخة الثانية (30 كتاباً)",
    description: "مجموعة إضافية من الروايات القصيرة والكتب الفكرية والتاريخية.",
    size: "1.8 MB",
    uploadedBy: TEACHER_NAME,
    date: "2026-09-16",
  },
  {
    id: 3,
    title: "قائمة الكتب القصيرة - النسخة الثالثة (30 كتاباً)",
    description: "كتب في السير الذاتية، الآداب العالمية، ورسائل الفلاسفة والأدباء.",
    size: "2.1 MB",
    uploadedBy: TEACHER_NAME,
    date: "2026-09-17",
  },
  {
    id: 4,
    title: "قائمة الكتب القصيرة - النسخة الرابعة (30 كتاباً)",
    description: "أحدث المختارات من المسرحيات، الدواوين الشعرية، وكتب الفكر والمنطق.",
    size: "2.0 MB",
    uploadedBy: TEACHER_NAME,
    date: "2026-09-18",
  },
...
export function PdfFilesSection({ query, canUpload }: { query: string; canUpload: boolean }) {
  ...
  const results = q ? files.filter((f) => f.title.toLowerCase().includes(q) || f.description.toLowerCase().includes(q)) : files;
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      <div className={canUpload ? "space-y-3 lg:col-span-2" : "space-y-3 lg:col-span-3"}>
        {results.length === 0 ? (
